            ...
            <div>
              ...
              <div className={style.MovieDetailsRatingContainer}>
                ...
                <div className={style.MovieDetailsRating}>
                  <p className={style.MovieDetailsRating}>
                    <span className={style.RatingSpan}>{movie.movieRating}</span>
                    /10
                  </p>
                </div>
              </div>
              ...
              <div className={style.MovieDetailsDescriptionContainer}>
                <p className={style.MovieDetailsDescription}>
                  {movie.movieDescription}
                </p>
              </div>

              <div className={style.MovieDetailsGenreContainer}>
                <p className={style.MovieDetailsGenre}>
                  <span>Genre(s):  </span>
                  {movie.movieGenre}
                </p>
              </div>
              ...
              <div className={style.MovieDetailsWatchContainer}>
                ...
                >
                  <button className={style.MovieDetailsWatchButton}>
                    Watch Now
                  </button>
                </a>
              </div>
